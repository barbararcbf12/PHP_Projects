...
$(document).ready(function(){
	...
	$.ajax({
			...
			//inserting new year
				...
				$("#free").prepend("<details id=free"+fullyear+" open><summary class='padding-year'><strong>"+fullyear+"</strong></summary><details open><summary class='padding-month'>"+swapMonth(month)+"</summary><ul id=free"+fullyear+"-"+month+"><li id='free"+date+"'><a href='"+urllink+"'"+" target='_blank'>"+date+"</a></li></ul></summary></details></summary></details>");
				}
				//inserting new month
				else if($("#free" + fullyear).length !== 0 && $("#free"+fullyear+"-"+month).length === 0){
				$("#free"+fullyear).prepend("<details open><summary class='padding-month'>"+swapMonth(month)+"</summary><ul id='free"+fullyear+"-"+month+"'><li id='free"+date+"'><a href='"+urllink+"'"+" target='_blank'>"+date+"</a></li></ul></summary></details>");
				} 
				//inserting new day
	...
	$.ajax({
			...
			//inserting new year
				if($("#free" + fullyear).length === 0) {
				$("#free").prepend("<details id=free"+fullyear+" open><summary class='padding-year'><strong>"+fullyear+"</strong></summary><details open><summary class='padding-month'>"+swapMonth(month)+"</summary><ul id=free"+fullyear+"-"+month+"><li id='free"+date+"'><a href='"+urllinkF+"'"+" target='_blank'>"+date+", Foreløbig</a></li></ul></summary></details></summary></details>");
				}
				//inserting new month
				else if($("#free" + fullyear).length !== 0 && $("#free"+fullyear+"-"+month).length === 0){
				$("#free"+fullyear).prepend("<details open><summary class='padding-month'>"+swapMonth(month)+"</summary><ul id='free"+fullyear+"-"+month+"'><li id='free"+date+"'><a href='"+urllinkF+"'"+" target='_blank'>"+date+", Foreløbig</a></li></ul></summary></details>");
				} 
				//inserting new day
